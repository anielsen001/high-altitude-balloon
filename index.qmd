...
### Testing with GNSS simulator

I set up a GNSS simulator to test the system without going outdoors. See [GNSS-SIM](https://apnielsen.com/gnss-sim) for more details about this set up.
